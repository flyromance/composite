! function () {
    if ("undefined" == typeof window.QIHOO_MONITOR) {
        var t = "v1.6.0 (2017.03.15)",
            ...
            n = function (r, i) {
                ...
                var o = document,
                    ...
                    p = {
                        ...
                        getLocation: function () {
                            var t = "";
                            try { t = location.href } catch (e) { t = o.createElement("a"), t.href = "", t = t.href }
                    ...
                    v = {
                        getBase: function () {
                            return { p: p.getProject(), u: p.getLocation(), guid: p.getGuid(), gid: p.getGid(), sid: p.getSid(), title: document.title, mid: p.getMid() }
                        },
                        getTrack: function (t) {
                            var e = p.getSid() === p.getSid() ? 1 : 0,
                                n = { b: p.getBrowser(), c: p.getCount(), r: p.getReferrer(), fl: p.getFlashVer(), sd: p.getColorDepth(), sr: p.getScreenSize(), ul: p.getLanguage(), ce: e };
                            if (t) {
                                t = t.split(",");
                ...
                return {
                    ...
                    sendLog: function () {
                        return r.__qihoo_monitor_imgs = {},
                            function (t) {
                                ...
                                n.onload = n.onerror = function () { r.__qihoo_monitor_imgs && r.__qihoo_monitor_imgs[e] && (r.__qihoo_monitor_imgs[e] = null, delete r.__qihoo_monitor_imgs[e]) }, n.src = t
                            }
                    }(),
                    buildLog: function () {
                        var t = "";
                    ...
                    init: function () { this.getClickAndKeydown(), this.getClickHeatmap(10, 1) },
                            ...
                            var i = 0,
                                a = function (o) {
                                    if (clearTimeout(i), o || r.length > t) {
                                        if (!r.length) return;
                                        return n.log({ pos: r.join(","), sr: p.getScreenSize() }, "clickHeatMap"), void(r = [])
                                    }
                                    i = setTimeout(function () { a(!0) }, 60 * e * 1e3)
                                };
        ...
        n.setConf({ trackUrl: r + "//s.360.cn/qdas/s.htm", clickUrl: r + "//s.360.cn/qdas/c.htm", clickHeatMapUrl: r + "//s.360.cn/qdas/t.htm", wpoUrl: r + "//s.360.cn/qdas/p.htm", heartbeatUrl: r + "//s.360.cn/qdas/h.htm" }).init(), window.QIHOO_MONITOR = n, "undefined" == typeof window.monitor && (window.monitor = n)
    }
}();
